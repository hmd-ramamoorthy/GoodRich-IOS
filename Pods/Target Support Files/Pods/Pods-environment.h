...
// ViSearch
#define COCOAPODS_POD_AVAILABLE_ViSearch
#define COCOAPODS_VERSION_MAJOR_ViSearch 0
#define COCOAPODS_VERSION_MINOR_ViSearch 0
#define COCOAPODS_VERSION_PATCH_ViSearch 4
