...
- (void)handleCurrentViewController:(NSNotification *)notification {
    if([[notification userInfo] objectForKey:@"lastViewController"]) {
        ...
        //NSLog(@"last view controller is %@", [self.lastViewController class]);
    }
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //[[UILabel appearance] setFont:[UIFont fontWithName"@hellowo"];
    
    // Unique application key for flurry: TYFBY3XCQNDVSF5SZJKBx
    [Flurry startSession:@"TYFBY3XCQNDVSF5SZJKB"];
    [Flurry logEvent:@"app launched"];
    [NewRelicAgent startWithApplicationToken:@"AA41cc7a23399ee7a9c07f58a0c049ab9e9de70ba4"];
    return YES;
}
