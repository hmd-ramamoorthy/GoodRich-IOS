...
@interface UISidebarViewController : UIViewController <SidebarItemClickedDelegate, ToggleSideBarButtonClickedDelegate>
    ...
    - (id)initWithCenterViewController:(UIViewController*)center
        andSidebarViewController:(MenuViewController*)sidebar;
